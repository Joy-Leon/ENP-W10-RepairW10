...
# Check the health of the Windows Image and perform a repair if needed
DISM /Online /Cleanup-Image /CheckHealth
DISM /Online /Cleanup-Image /ScanHealth
DISM /Online /Cleanup-Image /RestoreHealth

# Perform a system file scan and perform a repair if needed
SFC /scannow

# Check if any repairs were made to the system, there are any other remaining with a second scan.
SFC /scannow
